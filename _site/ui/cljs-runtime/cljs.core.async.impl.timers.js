...
var i_62957 = (0);
while(true){
if((i_62957 < arr.length)){
(arr[i_62957] = null);

var G__62963 = (i_62957 + (1));
i_62957 = G__62963;
continue;
} else {
}
...
var i_63005 = (self__.level + (1));
while(true){
if((i_63005 <= (new_level + (1)))){
(update[i_63005] = self__.header);

var G__63006 = (i_63005 + (1));
i_63005 = G__63006;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_63013 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_63013[i]));
} else {
x__$2.forward.push((((i < links_63013.length))?(links_63013[i]):null));
}

if((i < links_63013.length)){
(links_63013[i] = x__$2);
} else {
links_63013.push(x__$2);
}
...
var i_63023 = (0);
while(true){
if((i_63023 <= self__.level)){
var links_63027 = (update[i_63023]).forward;
if((x__$1 === (((i_63023 < links_63027.length))?(links_63027[i_63023]):null))){
(links_63027[i_63023] = (x__$1.forward[i_63023]));

var G__63034 = (i_63023 + (1));
i_63023 = G__63034;
continue;
} else {
var G__63035 = (i_63023 + (1));
i_63023 = G__63035;
continue;
}
} else {
...
var G__63059 = nx;
var G__63060 = (level__$1 - (1));
x = G__63059;
level__$1 = G__63060;
continue;
} else {
var G__63063 = x;
var G__63064 = (level__$1 - (1));
x = G__63063;
level__$1 = G__63064;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__63075 = nx;
var G__63076 = (level__$1 - (1));
x = G__63075;
level__$1 = G__63076;
continue;
} else {
var G__63079 = x;
var G__63080 = (level__$1 - (1));
x = G__63079;
level__$1 = G__63080;
continue;
}
