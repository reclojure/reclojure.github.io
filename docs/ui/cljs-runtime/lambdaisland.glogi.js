...
var G__55567 = lambdaisland.glogi.logger.cljs$core$IFn$_invoke$arity$1(name);
if((G__55567 == null)){
return null;
} else {
return lambdaisland.glogi.goog_setLevel(G__55567,lambdaisland.glogi.level(lvl));
}
});
/**
...
var seq__55572 = cljs.core.seq(lvls);
var chunk__55574 = null;
var count__55575 = (0);
var i__55576 = (0);
while(true){
if((i__55576 < count__55575)){
var vec__55590 = chunk__55574.cljs$core$IIndexed$_nth$arity$2(null,i__55576);
var logger = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55590,(0),null);
var level = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55590,(1),null);
var level_55658__$1 = ((typeof level === 'string')?cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(level):level);
lambdaisland.glogi.set_level(logger,level_55658__$1);


var G__55659 = seq__55572;
var G__55660 = chunk__55574;
var G__55661 = count__55575;
var G__55662 = (i__55576 + (1));
seq__55572 = G__55659;
chunk__55574 = G__55660;
count__55575 = G__55661;
i__55576 = G__55662;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__55572);
if(temp__5753__auto__){
var seq__55572__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__55572__$1)){
var c__4649__auto__ = cljs.core.chunk_first(seq__55572__$1);
var G__55664 = cljs.core.chunk_rest(seq__55572__$1);
var G__55665 = c__4649__auto__;
var G__55666 = cljs.core.count(c__4649__auto__);
var G__55667 = (0);
seq__55572 = G__55664;
chunk__55574 = G__55665;
count__55575 = G__55666;
i__55576 = G__55667;
continue;
} else {
var vec__55595 = cljs.core.first(seq__55572__$1);
var logger = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55595,(0),null);
var level = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55595,(1),null);
var level_55669__$1 = ((typeof level === 'string')?cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(level):level);
lambdaisland.glogi.set_level(logger,level_55669__$1);


var G__55670 = cljs.core.next(seq__55572__$1);
var G__55671 = null;
var G__55672 = (0);
var G__55673 = (0);
seq__55572 = G__55670;
chunk__55574 = G__55671;
count__55575 = G__55672;
i__55576 = G__55673;
continue;
}
} else {
...
var temp__5753__auto___55678 = goog.debug.Console.instance;
if(cljs.core.truth_(temp__5753__auto___55678)){
var instance_55679 = temp__5753__auto___55678;
instance_55679.setCapturing(true);

var instance_55680__$1 = (new goog.debug.Console());
(goog.debug.Console.instance = instance_55680__$1);

instance_55680__$1.setCapturing();
} else {
}
...
var G__55600 = (new goog.debug.FancyWindow());
G__55600.setEnabled(true);
...
var G__55601 = (new goog.debug.DivConsole(element));
G__55601.setCapturing(true);
...
var len__4829__auto___55684 = arguments.length;
var i__4830__auto___55686 = (0);
while(true){
if((i__4830__auto___55686 < len__4829__auto___55684)){
args__4835__auto__.push((arguments[i__4830__auto___55686]));

var G__55690 = (i__4830__auto___55686 + (1));
i__4830__auto___55686 = G__55690;
continue;
} else {
}
break;
...
/** @this {Function} */
(lambdaisland.glogi.swap_handlers_BANG_.cljs$lang$applyTo = (function (seq55603){
...
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55604,G__55605,seq55603__$2);
}));
...
var G__55616 = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"sequenceNumber","sequenceNumber",-543983615),record.sequenceNumber_,new cljs.core.Keyword(null,"time","time",1385887882),record.time_,new cljs.core.Keyword(null,"level","level",1290497552),cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(clojure.string.lower_case(record.level_.name)),new cljs.core.Keyword(null,"message","message",-406056002),record.msg_,new cljs.core.Keyword(null,"logger-name","logger-name",-1988126927),record.loggerName_,new cljs.core.Keyword(null,"exception","exception",-335277064),record.exception_], null);
return (handler_fn.cljs$core$IFn$_invoke$arity$1 ? handler_fn.cljs$core$IFn$_invoke$arity$1(G__55616) : handler_fn.call(null,G__55616));
});
if(cljs.core.truth_(logger)){
var temp__5753__auto___55704 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(lambdaisland.glogi.logger_glogi_handlers(logger),handler_fn);
if(cljs.core.truth_(temp__5753__auto___55704)){
var handler_55705 = temp__5753__auto___55704;
lambdaisland.glogi.goog_removeHandler(logger,handler_55705);
} else {
}
...
return lambdaisland.glogi.goog_addHandler(G__55617,log_record_handler);
}
} else {
return null;
}
...
var logger = lambdaisland.glogi.logger.cljs$core$IFn$_invoke$arity$1(name);
if(cljs.core.truth_(logger)){
var temp__5753__auto___55708 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(lambdaisland.glogi.logger_glogi_handlers(logger),handler_fn);
if(cljs.core.truth_(temp__5753__auto___55708)){
var handler_55709 = temp__5753__auto___55708;
lambdaisland.glogi.goog_removeHandler(logger,handler_55709);
} else {
}
