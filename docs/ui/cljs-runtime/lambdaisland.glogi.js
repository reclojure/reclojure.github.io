...
var G__50032 = lambdaisland.glogi.logger.cljs$core$IFn$_invoke$arity$1(name);
if((G__50032 == null)){
return null;
} else {
return lambdaisland.glogi.goog_setLevel(G__50032,lambdaisland.glogi.level(lvl));
}
});
/**
...
var seq__50036 = cljs.core.seq(lvls);
var chunk__50038 = null;
var count__50039 = (0);
var i__50040 = (0);
while(true){
if((i__50040 < count__50039)){
var vec__50049 = chunk__50038.cljs$core$IIndexed$_nth$arity$2(null,i__50040);
var logger = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50049,(0),null);
var level = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50049,(1),null);
var level_50117__$1 = ((typeof level === 'string')?cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(level):level);
lambdaisland.glogi.set_level(logger,level_50117__$1);


var G__50121 = seq__50036;
var G__50122 = chunk__50038;
var G__50123 = count__50039;
var G__50124 = (i__50040 + (1));
seq__50036 = G__50121;
chunk__50038 = G__50122;
count__50039 = G__50123;
i__50040 = G__50124;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__50036);
if(temp__5753__auto__){
var seq__50036__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__50036__$1)){
var c__4649__auto__ = cljs.core.chunk_first(seq__50036__$1);
var G__50125 = cljs.core.chunk_rest(seq__50036__$1);
var G__50126 = c__4649__auto__;
var G__50127 = cljs.core.count(c__4649__auto__);
var G__50128 = (0);
seq__50036 = G__50125;
chunk__50038 = G__50126;
count__50039 = G__50127;
i__50040 = G__50128;
continue;
} else {
var vec__50053 = cljs.core.first(seq__50036__$1);
var logger = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50053,(0),null);
var level = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50053,(1),null);
var level_50130__$1 = ((typeof level === 'string')?cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(level):level);
lambdaisland.glogi.set_level(logger,level_50130__$1);


var G__50134 = cljs.core.next(seq__50036__$1);
var G__50135 = null;
var G__50136 = (0);
var G__50137 = (0);
seq__50036 = G__50134;
chunk__50038 = G__50135;
count__50039 = G__50136;
i__50040 = G__50137;
continue;
}
} else {
...
var temp__5753__auto___50138 = goog.debug.Console.instance;
if(cljs.core.truth_(temp__5753__auto___50138)){
var instance_50139 = temp__5753__auto___50138;
instance_50139.setCapturing(true);

var instance_50140__$1 = (new goog.debug.Console());
(goog.debug.Console.instance = instance_50140__$1);

instance_50140__$1.setCapturing();
} else {
}
...
var G__50058 = (new goog.debug.FancyWindow());
G__50058.setEnabled(true);
...
var G__50062 = (new goog.debug.DivConsole(element));
G__50062.setCapturing(true);
...
/** @this {Function} */
(lambdaisland.glogi.swap_handlers_BANG_.cljs$lang$applyTo = (function (seq50063){
...
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50064,G__50065,seq50063__$2);
}));
...
return (handler_fn.cljs$core$IFn$_invoke$arity$1 ? handler_fn.cljs$core$IFn$_invoke$arity$1(G__50072) : handler_fn.call(null,G__50072));
});
if(cljs.core.truth_(logger)){
var temp__5753__auto___50152 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(lambdaisland.glogi.logger_glogi_handlers(logger),handler_fn);
if(cljs.core.truth_(temp__5753__auto___50152)){
var handler_50154 = temp__5753__auto___50152;
lambdaisland.glogi.goog_removeHandler(logger,handler_50154);
} else {
}
...
return lambdaisland.glogi.goog_addHandler(G__50075,log_record_handler);
}
} else {
return null;
}
...
var logger = lambdaisland.glogi.logger.cljs$core$IFn$_invoke$arity$1(name);
if(cljs.core.truth_(logger)){
var temp__5753__auto___50157 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(lambdaisland.glogi.logger_glogi_handlers(logger),handler_fn);
if(cljs.core.truth_(temp__5753__auto___50157)){
var handler_50158 = temp__5753__auto___50157;
lambdaisland.glogi.goog_removeHandler(logger,handler_50158);
} else {
}
