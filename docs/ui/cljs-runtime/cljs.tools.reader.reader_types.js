...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_40870 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_40870(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_40872 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_40872(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_40875 = (function (reader,ch){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_40875(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_40877 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_40877(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_40879 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_40879(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_40889 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_40889(reader);
}
});
...
var G__40946 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__40947 = s.append(c);
c = G__40946;
s = G__40947;
continue;
}
