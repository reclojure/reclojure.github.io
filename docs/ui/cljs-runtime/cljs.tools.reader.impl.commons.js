...
var G__41060 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__41060;
continue;
} else {
return ch;
...
var vec__41040 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41040,(0),null);
return (match === s);
});
...
var len__4829__auto___41083 = arguments.length;
var i__4830__auto___41084 = (0);
while(true){
if((i__4830__auto___41084 < len__4829__auto___41083)){
args__4835__auto__.push((arguments[i__4830__auto___41084]));

var G__41087 = (i__4830__auto___41084 + (1));
i__4830__auto___41084 = G__41087;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq41053){
var G__41054 = cljs.core.first(seq41053);
var seq41053__$1 = cljs.core.next(seq41053);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41054,seq41053__$1);
}));

cljs.tools.reader.impl.commons.throwing_reader = (function cljs$tools$reader$impl$commons$throwing_reader(msg){
return (function() { 
var G__41089__delegate = function (rdr,_){
...
var G__41089 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__41090__i = 0, G__41090__a = new Array(arguments.length -  1);
while (G__41090__i < G__41090__a.length) {G__41090__a[G__41090__i] = arguments[G__41090__i + 1]; ++G__41090__i;}
  _ = new cljs.core.IndexedSeq(G__41090__a,0,null);
} 
return G__41089__delegate.call(this,rdr,_);};
G__41089.cljs$lang$maxFixedArity = 1;
G__41089.cljs$lang$applyTo = (function (arglist__41091){
var rdr = cljs.core.first(arglist__41091);
var _ = cljs.core.rest(arglist__41091);
return G__41089__delegate(rdr,_);
});
