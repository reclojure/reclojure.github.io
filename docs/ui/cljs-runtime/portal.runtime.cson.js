...
var portal$runtime$cson$ToJson$_to_json$dyn_56697 = (function (value){
...
return portal$runtime$cson$ToJson$_to_json$dyn_56697(value);
}
});
...
(portal.runtime.cson.Tagged.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4474__auto__,k56660,else__4475__auto__){
var self__ = this;
var this__4474__auto____$1 = this;
var G__56664 = k56660;
var G__56664__$1 = (((G__56664 instanceof cljs.core.Keyword))?G__56664.fqn:null);
switch (G__56664__$1) {
case "-tag":
return self__._tag;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k56660,else__4475__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4495__auto__,p__56665){
var vec__56666 = p__56665;
var k__4496__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56666,(0),null);
var v__4497__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56666,(1),null);
...
(portal.runtime.cson.Tagged.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__56659){
var self__ = this;
var G__56659__$1 = this;
return (new cljs.core.RecordIter((0),G__56659__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"-tag","-tag",593200022),new cljs.core.Keyword(null,"value","value",305978217)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(portal.runtime.cson.Tagged.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this56661,other56662){
var self__ = this;
var this56661__$1 = this;
return (((!((other56662 == null)))) && ((((this56661__$1.constructor === other56662.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56661__$1._tag,other56662._tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56661__$1.value,other56662.value)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56661__$1.__extmap,other56662.__extmap)))))))));
}));
...
(portal.runtime.cson.Tagged.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4479__auto__,k56660){
var self__ = this;
var this__4479__auto____$1 = this;
var G__56669 = k56660;
var G__56669__$1 = (((G__56669 instanceof cljs.core.Keyword))?G__56669.fqn:null);
switch (G__56669__$1) {
case "-tag":
case "value":
return true;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k56660);

}
}));

(portal.runtime.cson.Tagged.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4480__auto__,k__4481__auto__,G__56659){
var self__ = this;
var this__4480__auto____$1 = this;
var pred__56670 = cljs.core.keyword_identical_QMARK_;
var expr__56671 = k__4481__auto__;
if(cljs.core.truth_((pred__56670.cljs$core$IFn$_invoke$arity$2 ? pred__56670.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"-tag","-tag",593200022),expr__56671) : pred__56670.call(null,new cljs.core.Keyword(null,"-tag","-tag",593200022),expr__56671)))){
return (new portal.runtime.cson.Tagged(G__56659,self__.value,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__56670.cljs$core$IFn$_invoke$arity$2 ? pred__56670.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"value","value",305978217),expr__56671) : pred__56670.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__56671)))){
return (new portal.runtime.cson.Tagged(self__._tag,G__56659,self__.__meta,self__.__extmap,null));
} else {
return (new portal.runtime.cson.Tagged(self__._tag,self__.value,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4481__auto__,G__56659),null));
}
}
}));
...
(portal.runtime.cson.Tagged.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4471__auto__,G__56659){
var self__ = this;
var this__4471__auto____$1 = this;
return (new portal.runtime.cson.Tagged(self__._tag,self__.value,G__56659,self__.__extmap,self__.__hash));
}));
 ...
 */
portal.runtime.cson.map__GT_Tagged = (function portal$runtime$cson$map__GT_Tagged(G__56663){
var extmap__4512__auto__ = (function (){var G__56673 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__56663,new cljs.core.Keyword(null,"-tag","-tag",593200022),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"value","value",305978217)], 0));
if(cljs.core.record_QMARK_(G__56663)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__56673);
} else {
return G__56673;
}
})();
return (new portal.runtime.cson.Tagged(new cljs.core.Keyword(null,"-tag","-tag",593200022).cljs$core$IFn$_invoke$arity$1(G__56663),new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__56663),null,cljs.core.not_empty(extmap__4512__auto__),null));
});

portal.runtime.cson.meta__GT_ = (function portal$runtime$cson$meta__GT_(value){
var vec__56674 = value;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56674,(0),null);
var obj = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56674,(1),null);
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56674,(2),null);
...
var vec__56677 = value;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56677,(0),null);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56677,(1),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56677,(2),null);
...
var vec__56680 = value;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56680,(0),null);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56680,(1),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56680,(2),null);
if(cljs.core.not(name)){
...
var G__56683 = cljs.core.first(value);
switch (G__56683) {
case "bigint":
...
break;
default:
var fexpr__56684 = new cljs.core.Keyword(null,"default-handler","default-handler",-1028159207).cljs$core$IFn$_invoke$arity$1(portal.runtime.cson._STAR_options_STAR_);
return (fexpr__56684.cljs$core$IFn$_invoke$arity$1 ? fexpr__56684.cljs$core$IFn$_invoke$arity$1(value) : fexpr__56684.call(null,value));
...
var fexpr__56686 = (function (){var or__4223__auto__ = new cljs.core.Keyword(null,"stringify","stringify",-1563846991).cljs$core$IFn$_invoke$arity$1(options);
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
return (function (p1__56685_SHARP_){
return JSON.stringify(p1__56685_SHARP_);
});
}
})();
return (fexpr__56686.cljs$core$IFn$_invoke$arity$1 ? fexpr__56686.cljs$core$IFn$_invoke$arity$1(value) : fexpr__56686.call(null,value));
});
portal.runtime.cson.write = (function portal$runtime$cson$write(var_args){
var G__56688 = arguments.length;
switch (G__56688) {
case 1:
...
var _STAR_options_STAR__orig_val__56689 = portal.runtime.cson._STAR_options_STAR_;
var _STAR_options_STAR__temp_val__56690 = options;
(portal.runtime.cson._STAR_options_STAR_ = _STAR_options_STAR__temp_val__56690);

try{return portal.runtime.cson.stringify(portal.runtime.cson.to_json(value),options);
}finally {(portal.runtime.cson._STAR_options_STAR_ = _STAR_options_STAR__orig_val__56689);
}}));
...
var fexpr__56692 = (function (){var or__4223__auto__ = new cljs.core.Keyword(null,"parse","parse",-1162164619).cljs$core$IFn$_invoke$arity$1(options);
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
return (function (p1__56691_SHARP_){
return JSON.parse(p1__56691_SHARP_);
});
}
})();
return (fexpr__56692.cljs$core$IFn$_invoke$arity$1 ? fexpr__56692.cljs$core$IFn$_invoke$arity$1(string) : fexpr__56692.call(null,string));
});
portal.runtime.cson.read = (function portal$runtime$cson$read(var_args){
var G__56694 = arguments.length;
switch (G__56694) {
case 1:
...
var _STAR_options_STAR__orig_val__56695 = portal.runtime.cson._STAR_options_STAR_;
var _STAR_options_STAR__temp_val__56696 = options;
(portal.runtime.cson._STAR_options_STAR_ = _STAR_options_STAR__temp_val__56696);

try{return portal.runtime.cson.json__GT_(portal.runtime.cson.parse(string,options));
}finally {(portal.runtime.cson._STAR_options_STAR_ = _STAR_options_STAR__orig_val__56695);
}}));
