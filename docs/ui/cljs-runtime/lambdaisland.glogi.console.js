...
var pred__55779 = (function (p1__55778_SHARP_,p2__55777_SHARP_){
return (p2__55777_SHARP_ >= p1__55778_SHARP_);
});
var expr__55780 = lambdaisland.glogi.level_value(level);
if(pred__55779(lambdaisland.glogi.level_value(new cljs.core.Keyword(null,"severe","severe",-1364500238)),expr__55780)){
return "error";
} else {
if(pred__55779(lambdaisland.glogi.level_value(new cljs.core.Keyword(null,"warning","warning",-1685650671)),expr__55780)){
return "warn";
} else {
if(pred__55779(lambdaisland.glogi.level_value(new cljs.core.Keyword(null,"info","info",-317069002)),expr__55780)){
return "info";
} else {
if(pred__55779(lambdaisland.glogi.level_value(new cljs.core.Keyword(null,"config","config",994861415)),expr__55780)){
return "log";
} else {
return "log";
}
...
lambdaisland.glogi.console.format_raw = (function lambdaisland$glogi$console$format_raw(p__55784){
var map__55786 = p__55784;
var map__55786__$1 = cljs.core.__destructure_map(map__55786);
var level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55786__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var logger_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55786__$1,new cljs.core.Keyword(null,"logger-name","logger-name",-1988126927));
var message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55786__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var exception = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55786__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
lambdaisland.glogi.console.format_css = (function lambdaisland$glogi$console$format_css(p__55789){
var map__55791 = p__55789;
var map__55791__$1 = cljs.core.__destructure_map(map__55791);
var level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55791__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var logger_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55791__$1,new cljs.core.Keyword(null,"logger-name","logger-name",-1988126927));
var message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55791__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var exception = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55791__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
return lambdaisland.glogi.print.format(level,logger_name,message);
});
lambdaisland.glogi.console.format_plain = (function lambdaisland$glogi$console$format_plain(p__55800){
var map__55802 = p__55800;
var map__55802__$1 = cljs.core.__destructure_map(map__55802);
var level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55802__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var logger_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55802__$1,new cljs.core.Keyword(null,"logger-name","logger-name",-1988126927));
var message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55802__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var exception = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55802__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var record = map__55805__$1;
var logger_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55805__$1,new cljs.core.Keyword(null,"logger-name","logger-name",-1988126927));
var level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55805__$1,new cljs.core.Keyword(null,"level","level",1290497552));
var exception = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55805__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var G__55808 = ["[",cljs.core.str.cljs$core$IFn$_invoke$arity$1(logger_name),"]"].join('');
var G__55809 = cljs.core.str.cljs$core$IFn$_invoke$arity$1(exception);
var G__55810 = "\n";
var G__55811 = exception.stack;
return (method.cljs$core$IFn$_invoke$arity$4 ? method.cljs$core$IFn$_invoke$arity$4(G__55808,G__55809,G__55810,G__55811) : method.call(null,G__55808,G__55809,G__55810,G__55811));
} else {
return null;
}
});
...
var G__55821 = lambdaisland.glogi.console.colorize;
switch (G__55821) {
case "auto":
...
break;
default:
throw (new Error(["No matching clause: ",G__55821].join('')));

}
});
lambdaisland.glogi.console.install_BANG_ = (function lambdaisland$glogi$console$install_BANG_(){
var temp__5753__auto___55879 = goog.debug.Console.instance;
if(cljs.core.truth_(temp__5753__auto___55879)){
var instance_55880 = temp__5753__auto___55879;
instance_55880.setCapturing(false);
} else {
}

var G__55828 = lambdaisland.glogi.console.select_handler();
return (lambdaisland.glogi.add_handler_once.cljs$core$IFn$_invoke$arity$1 ? lambdaisland.glogi.add_handler_once.cljs$core$IFn$_invoke$arity$1(G__55828) : lambdaisland.glogi.add_handler_once.call(null,G__55828));
});
