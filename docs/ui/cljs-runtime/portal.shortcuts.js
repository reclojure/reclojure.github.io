...
if(cljs.core.truth_((function (){var fexpr__56600 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, ["Mac68K",null,"Macintosh",null,"MacPPC",null,"MacIntel",null], null), null);
return (fexpr__56600.cljs$core$IFn$_invoke$arity$1 ? fexpr__56600.cljs$core$IFn$_invoke$arity$1(platform) : fexpr__56600.call(null,platform));
})())){
return new cljs.core.Keyword("portal.shortcuts","osx","portal.shortcuts/osx",300522451);
} else {
if(cljs.core.truth_((function (){var fexpr__56602 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, ["WinCE",null,"Windows",null,"Win32",null,"Win64",null], null), null);
return (fexpr__56602.cljs$core$IFn$_invoke$arity$1 ? fexpr__56602.cljs$core$IFn$_invoke$arity$1(platform) : fexpr__56602.call(null,platform));
})())){
...
var iter__4622__auto__ = (function portal$shortcuts$log__GT_seq_$_iter__56608(s__56609){
return (new cljs.core.LazySeq(null,(function (){
var s__56609__$1 = s__56609;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__56609__$1);
if(temp__5753__auto__){
var s__56609__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__56609__$2)){
var c__4620__auto__ = cljs.core.chunk_first(s__56609__$2);
var size__4621__auto__ = cljs.core.count(c__4620__auto__);
var b__56611 = cljs.core.chunk_buffer(size__4621__auto__);
if((function (){var i__56610 = (0);
while(true){
if((i__56610 < size__4621__auto__)){
var n = cljs.core._nth(c__4620__auto__,i__56610);
cljs.core.chunk_append(b__56611,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.reverse(cljs.core.take.cljs$core$IFn$_invoke$arity$2(n,log__$1))));

var G__56634 = (i__56610 + (1));
i__56610 = G__56634;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56611),portal$shortcuts$log__GT_seq_$_iter__56608(cljs.core.chunk_rest(s__56609__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56611),null);
}
} else {
var n = cljs.core.first(s__56609__$2);
return cljs.core.cons(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.reverse(cljs.core.take.cljs$core$IFn$_invoke$arity$2(n,log__$1))),portal$shortcuts$log__GT_seq_$_iter__56608(cljs.core.rest(s__56609__$2)));
}
} else {
return null;
}
...
var G__56616 = cljs.core.PersistentHashSet.createAsIfByAssoc([portal.shortcuts.event__GT_key(e)]);
var G__56616__$1 = (cljs.core.truth_(e.ctrlKey)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__56616,"control"):G__56616);
var G__56616__$2 = (cljs.core.truth_(e.metaKey)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__56616__$1,"meta"):G__56616__$1);
var G__56616__$3 = (cljs.core.truth_(e.shiftKey)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__56616__$2,"shift"):G__56616__$2);
if(cljs.core.truth_(e.altKey)){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__56616__$3,"alt");
} else {
return G__56616__$3;
}
} else {
...
if(cljs.core.truth_(temp__5753__auto__)){
var e = temp__5753__auto__;
var G__56621 = e.target.tagName;
var fexpr__56620 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, ["SELECT",null,"INPUT",null,"BUTTON",null], null), null);
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(portal.shortcuts.log,(function (p1__56624_SHARP_){
return cljs.core.take.cljs$core$IFn$_invoke$arity$2((5),cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__56624_SHARP_,e));
}));
});
...
return window.addEventListener("keydown",(function (p1__56625_SHARP_){
return portal.shortcuts.keydown(p1__56625_SHARP_);
}));
} else {
return null;
}
