...
portal.runtime.open_session = (function portal$runtime$open_session(p__56701){
var map__56702 = p__56701;
var map__56702__$1 = cljs.core.__destructure_map(map__56702);
var session = map__56702__$1;
var session_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56702__$1,new cljs.core.Keyword(null,"session-id","session-id",-1147060351));
...
var G__56703 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"op","op",-1882987955),new cljs.core.Keyword("portal.rpc","update-versions","portal.rpc/update-versions",-369309079),new cljs.core.Keyword(null,"body","body",-2049205669),new$], null);
return (request.cljs$core$IFn$_invoke$arity$1 ? request.cljs$core$IFn$_invoke$arity$1(G__56703) : request.call(null,G__56703));
} else {
return null;
}
} else {
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$3(value,cljs.core.merge,(function (){var G__56710 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("portal.runtime","id","portal.runtime/id",1768418782),portal.runtime.value__GT_id(value)], null);
if(cljs.core.record_QMARK_(value)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__56710,new cljs.core.Keyword("portal.runtime","type","portal.runtime/type",36635890),cljs.core.type(value));
} else {
return G__56710;
}
})());
...
var _STAR_session_STAR__orig_val__56711 = portal.runtime._STAR_session_STAR_;
var _STAR_session_STAR__temp_val__56712 = session;
(portal.runtime._STAR_session_STAR_ = _STAR_session_STAR__temp_val__56712);
...
}finally {(portal.runtime._STAR_session_STAR_ = _STAR_session_STAR__orig_val__56711);
}});
...
var _STAR_session_STAR__orig_val__56713 = portal.runtime._STAR_session_STAR_;
var _STAR_session_STAR__temp_val__56714 = session;
(portal.runtime._STAR_session_STAR_ = _STAR_session_STAR__temp_val__56714);
...
var G__56715 = cljs.core.first(value);
switch (G__56715) {
case "ref":
...
}finally {(portal.runtime._STAR_session_STAR_ = _STAR_session_STAR__orig_val__56713);
}});
...
var seq__56718_56748 = cljs.core.seq(cljs.core.deref(portal.runtime.watch_registry));
var chunk__56719_56750 = null;
var count__56720_56751 = (0);
var i__56721_56753 = (0);
while(true){
if((i__56721_56753 < count__56720_56751)){
var vec__56728_56754 = chunk__56719_56750.cljs$core$IIndexed$_nth$arity$2(null,i__56721_56753);
var a_56755 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56728_56754,(0),null);
cljs.core.remove_watch(a_56755,new cljs.core.Keyword("portal.runtime","watch-key","portal.runtime/watch-key",393909598));


var G__56756 = seq__56718_56748;
var G__56757 = chunk__56719_56750;
var G__56758 = count__56720_56751;
var G__56759 = (i__56721_56753 + (1));
seq__56718_56748 = G__56756;
chunk__56719_56750 = G__56757;
count__56720_56751 = G__56758;
i__56721_56753 = G__56759;
continue;
} else {
var temp__5753__auto___56760 = cljs.core.seq(seq__56718_56748);
if(temp__5753__auto___56760){
var seq__56718_56761__$1 = temp__5753__auto___56760;
if(cljs.core.chunked_seq_QMARK_(seq__56718_56761__$1)){
var c__4649__auto___56762 = cljs.core.chunk_first(seq__56718_56761__$1);
var G__56766 = cljs.core.chunk_rest(seq__56718_56761__$1);
var G__56767 = c__4649__auto___56762;
var G__56768 = cljs.core.count(c__4649__auto___56762);
var G__56769 = (0);
seq__56718_56748 = G__56766;
chunk__56719_56750 = G__56767;
count__56720_56751 = G__56768;
i__56721_56753 = G__56769;
continue;
} else {
var vec__56731_56770 = cljs.core.first(seq__56718_56761__$1);
var a_56771 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56731_56770,(0),null);
cljs.core.remove_watch(a_56771,new cljs.core.Keyword("portal.runtime","watch-key","portal.runtime/watch-key",393909598));


var G__56772 = cljs.core.next(seq__56718_56761__$1);
var G__56773 = null;
var G__56774 = (0);
var G__56775 = (0);
seq__56718_56748 = G__56772;
chunk__56719_56750 = G__56773;
count__56720_56751 = G__56774;
i__56721_56753 = G__56775;
continue;
}
} else {
}
...
portal.runtime.predicates = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("clojure.core","deref","clojure.core/deref",188719157,null),(function (p1__56737_SHARP_){
if((!((p1__56737_SHARP_ == null)))){
if((((p1__56737_SHARP_.cljs$lang$protocol_mask$partition0$ & (32768))) || ((cljs.core.PROTOCOL_SENTINEL === p1__56737_SHARP_.cljs$core$IDeref$)))){
return true;
} else {
if((!p1__56737_SHARP_.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_(cljs.core.IDeref,p1__56737_SHARP_);
} else {
return false;
}
}
...
portal.runtime.invoke = (function portal$runtime$invoke(p__56740,done){
var map__56741 = p__56740;
var map__56741__$1 = cljs.core.__destructure_map(map__56741);
var f = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56741__$1,new cljs.core.Keyword(null,"f","f",-1597136552));
var args = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56741__$1,new cljs.core.Keyword(null,"args","args",1315556576));
...
return Promise.resolve((function (){var G__56744 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"return","return",-1891502105),return$], null);
return (done.cljs$core$IFn$_invoke$arity$1 ? done.cljs$core$IFn$_invoke$arity$1(G__56744) : done.call(null,G__56744));
})());
}));
}));
}catch (e56742){if((e56742 instanceof Error)){
var e = e56742;
var G__56743 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"return","return",-1891502105),e], null);
return (done.cljs$core$IFn$_invoke$arity$1 ? done.cljs$core$IFn$_invoke$arity$1(G__56743) : done.call(null,G__56743));
} else {
throw e56742;
