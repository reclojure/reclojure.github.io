...
var len__4829__auto___41013 = arguments.length;
var i__4830__auto___41027 = (0);
while(true){
if((i__4830__auto___41027 < len__4829__auto___41013)){
args__4835__auto__.push((arguments[i__4830__auto___41027]));

var G__41028 = (i__4830__auto___41027 + (1));
i__4830__auto___41027 = G__41028;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.throw_ex.cljs$lang$applyTo = (function (seq40880){
var G__40881 = cljs.core.first(seq40880);
var seq40880__$1 = cljs.core.next(seq40880);
var G__40882 = cljs.core.first(seq40880__$1);
var seq40880__$2 = cljs.core.next(seq40880__$1);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40881,G__40882,seq40880__$2);
}));
...
var args__4835__auto__ = [];
var len__4829__auto___41029 = arguments.length;
var i__4830__auto___41030 = (0);
while(true){
if((i__4830__auto___41030 < len__4829__auto___41029)){
args__4835__auto__.push((arguments[i__4830__auto___41030]));

var G__41031 = (i__4830__auto___41030 + (1));
i__4830__auto___41030 = G__41031;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.reader_error.cljs$lang$applyTo = (function (seq40899){
var G__40900 = cljs.core.first(seq40899);
var seq40899__$1 = cljs.core.next(seq40899);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40900,seq40899__$1);
}));
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.illegal_arg_error.cljs$lang$applyTo = (function (seq40908){
var G__40909 = cljs.core.first(seq40908);
var seq40908__$1 = cljs.core.next(seq40908);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40909,seq40908__$1);
}));
...
var args__4835__auto__ = [];
var len__4829__auto___41036 = arguments.length;
var i__4830__auto___41037 = (0);
while(true){
if((i__4830__auto___41037 < len__4829__auto___41036)){
args__4835__auto__.push((arguments[i__4830__auto___41037]));

var G__41039 = (i__4830__auto___41037 + (1));
i__4830__auto___41037 = G__41039;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.eof_error.cljs$lang$applyTo = (function (seq40914){
var G__40915 = cljs.core.first(seq40914);
var seq40914__$1 = cljs.core.next(seq40914);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40915,seq40914__$1);
}));
...
var init = (function (){var G__40954 = kind;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__40954__$1)].join('')));
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.throw_eof_reading.cljs$lang$applyTo = (function (seq40949){
var G__40950 = cljs.core.first(seq40949);
var seq40949__$1 = cljs.core.next(seq40949);
var G__40951 = cljs.core.first(seq40949__$1);
var seq40949__$2 = cljs.core.next(seq40949__$1);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40950,G__40951,seq40949__$2);
}));
...
var iter__4622__auto__ = (function cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__40989(s__40990){
return (new cljs.core.LazySeq(null,(function (){
var s__40990__$1 = s__40990;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__40990__$1);
if(temp__5753__auto__){
var s__40990__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__40990__$2)){
var c__4620__auto__ = cljs.core.chunk_first(s__40990__$2);
var size__4621__auto__ = cljs.core.count(c__4620__auto__);
var b__40992 = cljs.core.chunk_buffer(size__4621__auto__);
if((function (){var i__40991 = (0);
while(true){
if((i__40991 < size__4621__auto__)){
var vec__40994 = cljs.core._nth(c__4620__auto__,i__40991);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40994,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40994,(1),null);
if((freq > (1))){
cljs.core.chunk_append(b__40992,id);

var G__41067 = (i__40991 + (1));
i__40991 = G__41067;
continue;
} else {
var G__41068 = (i__40991 + (1));
i__40991 = G__41068;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__40992),cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__40989(cljs.core.chunk_rest(s__40990__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__40992),null);
}
} else {
var vec__40998 = cljs.core.first(s__40990__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40998,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40998,(1),null);
if((freq > (1))){
return cljs.core.cons(id,cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__40989(cljs.core.rest(s__40990__$2)));
} else {
var G__41069 = cljs.core.rest(s__40990__$2);
s__40990__$1 = G__41069;
continue;
}
}
} else {
